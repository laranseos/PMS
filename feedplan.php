                ...
                <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="row ">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" style="border-radius: 10px;" name="start" value="" placeholder="Enter Start Day..." class="form-control" id="start"required>
                    </div>
                  </div>
                  <div class="row ">
                    <div class="form-group col-md-6">
                      <label for="exampleInputName1">End Day</label>
                      <input type="text" style="border-radius: 10px;" name="end" value="" placeholder="Enter End Day..." class="form-control" id="end" required>
                    </div>
                  </div>
                  <div class="row ">
                    <div class="form-group col-md-6">
                      <label for="exampleInputName1">Feed per day(Kg)</label>
                      <input type="text" style="border-radius: 10px;" name="fpd" placeholder="Enter Feed per day..." class="form-control" id="fpd" value="" required>
                    </div>
                  </div>
                    ...
                    if($query->rowCount() > 0)
                    {
                      ...
                      { 
                        ...
                        <tr>
                          ...
                          <td class="text-center"> <a href="feedplan.php?del=<?php echo $row->id;?>&cate_id=<?php echo $cate;?>" data-toggle="tooltip" data-original-title="Delete" onclick="return confirm('Do you really want to delete?');"> <i class="mdi mdi-delete" style="color: #f05050"></i> </a>
                          </td>
                        </tr>
                        <?php 
                        $cnt=$cnt+1;
