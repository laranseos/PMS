...
if(!empty($_POST["fullname"])) {
  ...
  if($query -> rowCount() > 0)
  {
    ...
    { 
        ...
        $sql="INSERT INTO  tbladmin(AdminName,UserName,FirstName,LastName,FarmName,MyAddress,Email,MobileNumber,Password) VALUES(:dignity,:fname,:firstname,:lastname,:farmname,:myaddress,:email,:mobile,:password)";
        $query = $dbh->prepare($sql);
...
<div class="card-body">
    <form  method="post" name="signup" onSubmit="return valid();">
        ...
        <div class="row">
            <div class="form-group col-md-6">
                <input type="text" class="form-control" name="farmname" placeholder="Farm Name" required="required">
            </div>
            <div class="form-group col-md-6">
                <input type="text" class="form-control" name="myaddress" placeholder="Address" required="required">
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-6">
