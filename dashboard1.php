          ...
          <div class="row" style="margin-bottom: 20px;">
            ...
            <div class="col-xxl-4 col-md-2">
              <div class="card info-card sales-card" style="min-height: 160px;">
                ...
                <div class="card-body" style="background-color: #808A8A; color:antiquewhite">
                  ...
                  <hr>
                  <div class="d-flex align-items-center">
                  <a href="dashboard.php?download=eggs" title="Download"><i class="mdi mdi-download mdi-36px float-center" style="color:white;"></i></a>
                  </div>
                </div>
