...
if(isset($_POST['insertss']))
{
    ...
    $sql4="update tblcategory set tblcategory.cocks=:cocks, tblcategory.hews=:hews, tblcategory.breed=:breed, tblcategory.CategoryCode=:code, tblcategory.PostingDate=:birth where id=:eid";
    ...
    if($query2->rowCount() > 0)
    {
        foreach($results as $row)
        {
            ...
            <form class="form-sample"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                         ...
                         <div class="row" style="display: none;">
                            ...
                            <input type="date" style="border-radius: 10px;" name="birth" id="birth" value="<?php echo $row->PostingDate;?>" required />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 ">
                                ...
                                <div class="col-sm-12 pl-0 pr-0">
                                    <input type="text" style="border-radius: 8px;" name="code" id="code" placeholder="Enter Number of Chickens..." style="min-width:160px;" class="form-control" required>
                                </div>
                            </div>
                        </div>
                ...
                <button type="submit" name="insertss" id='addchickens' class="btn btn-info btn-fw mr-2" style="float: left; border-radius: 8px;" onclick="return confirm('Do you really want to add '+document.getElementById('code').value+' chickens?');">Add</button>
            </form>
            <?php 
        }
    } ?>
...
var checkbox = document.getElementById("dayold");
...
<script>
var ageInputs = document.getElementById("age");
var unitSelects = document.getElementById("unit");
...
function calculateOutput() {
  ...
  var birthDate = today.toISOString().split("T")[0];
