                  ...
                  <div class="col-md-3 stretch-card grid-margin" style="padding-right: 2px;">
                    <div class="card card1" style="min-height: 35vh;">
                      ...
                      <div class="card-body">
                          ...
                          <label for="fpd" style="color: #aaaaaa;">Age (days/weeks)</label><input type="" class="text-center" name='fpd'readonly="readonly" value="<?php  echo htmlentities($fdays_string);?>" style="resize: vertical; width: 100%; border: none; border-color: transparent;"></input>
                          <hr style="margin-top: 6px; margin-bottom:6px;">
