                        ...
                        <div class="col-md-12 stretch-card grid-margin card2" style="margin-left:18px; margin-bottom:10px;">
                          ...
                          <?php } ?>
                            <div class="card-header">
                                <?php if($left<0) { ?>
                                  <h4 class="text-center"><span class="float-left"><?php  echo htmlentities(abs($left));?>DAYS PASSED</span><span class="text-center header" style="color: #00008b;" id="title"><?php  echo htmlentities($row->CategoryFowlRun);?></span><i  style="color: #0DCEF0;" class="mdi mdi-pin mdi-24px float-right"></i></h4>
                                <?php } else {
                                  if($cnt == 1) {
                                  ?> 
